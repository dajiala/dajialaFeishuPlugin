...
`}var qo=/\r?\n|\r/g;function Jo(e,t){let n=[],r=0,i=0,a;for(;a=qo.exec(e);)o(e.slice(r,a.index)),n.push(a[0]),r=a.index+a[0].length,i++;return o(e.slice(r)),n.join(``);function o(e){n.push(t(e,i,!e))}}function Yo(e){if(!e._compiled){let t=(e.atBreak?`[\\r\\n][\\t ]*`:``)+(e.before?`(?:`+e.before+`)`:``);e._compiled=RegExp((t?`(`+t+`)`:``)+(/[|\\{}()[\]^$+*?.-]/.test(e.character)?`\\`:``)+e.character+(e.after?`(?:`+e.after+`)`:``),`g`)}return e._compiled}function Xo(e,t){return Zo(e,t.inConstruct,!0)&&!Zo(e,t.notInConstruct,!1)}function Zo(e,t,n){if(typeof t==`string`&&(t=[t]),!t||t.length===0)return n;let r=-1;for(;++r<t.length;)if(e.includes(t[r]))return!0;return!1}function Qo(e,t,n){let r=(n.before||``)+(t||``)+(n.after||``),i=[],a=[],o={},s=-1;for(;++s<e.unsafe.length;){let t=e.unsafe[s];if(!Xo(e.stack,t))continue;let n=Yo(t),a;for(;a=n.exec(r);){let e=`before`in t||!!t.atBreak,n=`after`in t,r=a.index+(e?a[1].length:0);i.includes(r)?(o[r].before&&!e&&(o[r].before=!1),o[r].after&&!n&&(o[r].after=!1)):(i.push(r),o[r]={before:e,after:n})}}i.sort($o);let c=n.before?n.before.length:0,l=r.length-(n.after?n.after.length:0);for(s=-1;++s<i.length;){let e=i[s];e<c||e>=l||e+1<l&&i[s+1]===e+1&&o[e].after&&!o[e+1].before&&!o[e+1].after||i[s-1]===e-1&&o[e].before&&!o[e-1].before&&!o[e-1].after||(c!==e&&a.push(es(r.slice(c,e),`\\`)),c=e,/[!-/:-@[-`{-~]/.test(r.charAt(e))&&(!n.encode||!n.encode.includes(r.charAt(e)))?a.push(`\\`):(a.push(`&#x`+r.charCodeAt(e).toString(16).toUpperCase()+`;`),c++))}return a.push(es(r.slice(c,l),n.after)),a.join(``)}function $o(e,t){return e-t}function es(e,t){let n=/\\(?=[!-/:-@[-`{-~])/g,r=[],i=[],a=e+t,o=-1,s=0,c;for(;c=n.exec(a);)r.push(c.index);for(;++o<r.length;)s!==r[o]&&i.push(e.slice(s,r[o])),i.push(`\\`),s=r[o];return i.push(e.slice(s)),i.join(``)}function ts(e){let t=e||{},n=t.now||{},r=t.lineShift||0,i=n.line||1,a=n.column||1;return{move:c,current:o,shift:s};function o(){return{now:{line:i,column:a},lineShift:r}}function s(e){r+=e}function c(e){let t=e||``,n=t.split(/\r?\n|\r/g),o=n[n.length-1];return i+=n.length-1,a=n.length===1?a+o.length:1+o.length+r,t}}fs.peek=ps;function ns(){return{enter:{gfmFootnoteDefinition:is,gfmFootnoteDefinitionLabelString:as,gfmFootnoteCall:cs,gfmFootnoteCallString:ls},exit:{gfmFootnoteDefinition:ss,gfmFootnoteDefinitionLabelString:os,gfmFootnoteCall:ds,gfmFootnoteCallString:us}}}function rs(){return{unsafe:[{character:`[`,inConstruct:[`phrasing`,`label`,`reference`]}],handlers:{footnoteDefinition:ms,footnoteReference:fs}}}function is(e){this.enter({type:`footnoteDefinition`,identifier:``,label:``,children:[]},e)}function as(){this.buffer()}function os(e){let t=this.resume(),n=this.stack[this.stack.length-1];n.label=t,n.identifier=H(this.sliceSerialize(e)).toLowerCase()}function ss(e){this.exit(e)}function cs(e){this.enter({type:`footnoteReference`,identifier:``,label:``},e)}function ls(){this.buffer()}function us(e){let t=this.resume(),n=this.stack[this.stack.length-1];n.label=t,n.identifier=H(this.sliceSerialize(e)).toLowerCase()}function ds(e){this.exit(e)}function fs(t,r,i,a){let o=ts(a),s=o.move(`[^`),c=i.enter(`footnoteReference`),l=i.enter(`reference`);return s+=o.move(Qo(i,Wo(t),n(e({},o.current()),{before:s,after:`]`}))),l(),c(),s+=o.move(`]`),s}function ps(){return`[`}function ms(t,r,i,a){let o=ts(a),s=o.move(`[^`),c=i.enter(`footnoteDefinition`),l=i.enter(`label`);return s+=o.move(Qo(i,Wo(t),n(e({},o.current()),{before:s,after:`]`}))),l(),s+=o.move(`]:`+(t.children&&t.children.length>0?` `:``)),o.shift(4),s+=o.move(Jo(Go(t,i,o.current()),hs)),c(),s}function hs(e,t,n){return t===0?e:(n?``:`    `)+e}function gs(t,r,i){let a=r.indexStack,o=t.children||[],s=[],c=-1,l=i.before;a.push(-1);let u=r.createTracker(i);for(;++c<o.length;){let d=o[c],f;if(a[a.length-1]=c,c+1<o.length){let n=r.handle.handlers[o[c+1].type];n&&n.peek&&(n=n.peek),f=n?n(o[c+1],t,r,e({before:``,after:``},u.current())).charAt(0):``}else f=i.after;s.length>0&&(l===`\r`||l===`
`)&&d.type===`html`&&(s[s.length-1]=s[s.length-1].replace(/(\r?\n|\r)$/,` `),l=` `,u=r.createTracker(i),u.move(s.join(``))),s.push(u.move(r.handle(d,t,r,n(e({},u.current()),{before:l,after:f})))),l=s[s.length-1].slice(-1)}return a.pop(),s.join(``)}var _s=[`autolink`,`destinationLiteral`,`destinationRaw`,`reference`,`titleQuote`,`titleApostrophe`];Ss.peek=Cs;var vs={canContainEols:[`delete`],enter:{strikethrough:bs},exit:{strikethrough:xs}},ys={unsafe:[{character:`~`,inConstruct:`phrasing`,notInConstruct:_s}],handlers:{delete:Ss}};function bs(e){this.enter({type:`delete`,children:[]},e)}function xs(e){this.exit(e)}function Ss(t,r,i,a){let o=ts(a),s=i.enter(`strikethrough`),c=o.move(`~~`);return c+=gs(t,i,n(e({},o.current()),{before:c,after:`~`})),c+=o.move(`~~`),s(),c}function Cs(){return`~`}ws.peek=Ts;function ws(e,t,n){let r=e.value||``,i="`",a=-1;for(;RegExp("(^|[^`])"+i+"([^`]|$)").test(r);)i+="`";for(/[^ \r\n]/.test(r)&&(/^[ \r\n]/.test(r)&&/[ \r\n]$/.test(r)||/^`|`$/.test(r))&&(r=` `+r+` `);++a<n.unsafe.length;){let e=n.unsafe[a],t=Yo(e),i;if(e.atBreak)for(;i=t.exec(r);){let e=i.index;r.charCodeAt(e)===10&&r.charCodeAt(e-1)===13&&e--,r=r.slice(0,e)+` `+r.slice(i.index+1)}}return i+r+i}function Ts(){return"`"}function Es(e){return e.length}function Ds(e,t){let n=t||{},r=(n.align||[]).concat(),i=n.stringLength||Es,a=[],o=[],s=[],c=[],l=0,u=-1;for(;++u<e.length;){let t=[],r=[],a=-1;for(e[u].length>l&&(l=e[u].length);++a<e[u].length;){let o=Os(e[u][a]);if(n.alignDelimiters!==!1){let e=i(o);r[a]=e,(c[a]===void 0||e>c[a])&&(c[a]=e)}t.push(o)}o[u]=t,s[u]=r}let d=-1;if(typeof r==`object`&&`length`in r)for(;++d<l;)a[d]=ks(r[d]);else{let e=ks(r);for(;++d<l;)a[d]=e}d=-1;let f=[],p=[];for(;++d<l;){let e=a[d],t=``,r=``;e===99?(t=`:`,r=`:`):e===108?t=`:`:e===114&&(r=`:`);let i=n.alignDelimiters===!1?1:Math.max(1,c[d]-t.length-r.length),o=t+`-`.repeat(i)+r;n.alignDelimiters!==!1&&(i=t.length+i+r.length,i>c[d]&&(c[d]=i),p[d]=i),f[d]=o}o.splice(1,0,f),s.splice(1,0,p),u=-1;let m=[];for(;++u<o.length;){let e=o[u],t=s[u];d=-1;let r=[];for(;++d<l;){let i=e[d]||``,o=``,s=``;if(n.alignDelimiters!==!1){let e=c[d]-(t[d]||0),n=a[d];n===114?o=` `.repeat(e):n===99?e%2?(o=` `.repeat(e/2+.5),s=` `.repeat(e/2-.5)):(o=` `.repeat(e/2),s=o):s=` `.repeat(e)}n.delimiterStart!==!1&&!d&&r.push(`|`),n.padding!==!1&&!(n.alignDelimiters===!1&&i===``)&&(n.delimiterStart!==!1||d)&&r.push(` `),n.alignDelimiters!==!1&&r.push(o),r.push(i),n.alignDelimiters!==!1&&r.push(s),n.padding!==!1&&r.push(` `),(n.delimiterEnd!==!1||d!==l-1)&&r.push(`|`)}m.push(n.delimiterEnd===!1?r.join(``).replace(/ +$/,``):r.join(``))}return m.join(`
`)}function Os(e){return e==null?``:String(e)}function ks(e){let t=typeof e==`string`?e.codePointAt(0):0;return t===67||t===99?99:t===76||t===108?108:t===82||t===114?114:0}var As={enter:{table:js,tableData:Fs,tableHeader:Fs,tableRow:Ns},exit:{codeText:Is,table:Ms,tableData:Ps,tableHeader:Ps,tableRow:Ps}};function js(e){let t=e._align;this.enter({type:`table`,align:t.map(e=>e===`none`?null:e),children:[]},e),this.setData(`inTable`,!0)}function Ms(e){this.exit(e),this.setData(`inTable`)}function Ns(e){this.enter({type:`tableRow`,children:[]},e)}function Ps(e){this.exit(e)}function Fs(e){this.enter({type:`tableCell`,children:[]},e)}function Is(e){let t=this.resume();this.getData(`inTable`)&&(t=t.replace(/\\([\\|])/g,Ls));let n=this.stack[this.stack.length-1];n.value=t,this.exit(e)}function Ls(e,t){return t===`|`?t:e}function Rs(t){let r=t||{},i=r.tableCellPadding,a=r.tablePipeAlign,o=r.stringLength,s=i?` `:`|`;return{unsafe:[{character:`\r`,inConstruct:`tableCell`},{character:`
...
`))}function u(t,r,i,a){let o=i.enter(`tableCell`),c=i.enter(`phrasing`),l=gs(t,i,n(e({},a),{before:s,after:s}));return c(),o(),l}function d(e,t){return Ds(e,{align:t,alignDelimiters:a,padding:i,stringLength:o})}function f(e,t,n){let r=e.children,i=-1,a=[],o=t.enter(`table`);for(;++i<r.length;)a[i]=p(r[i],t,n);return o(),a}function p(e,t,n){let r=e.children,i=-1,a=[],o=t.enter(`tableRow`);for(;++i<r.length;)a[i]=u(r[i],e,t,n);return o(),a}function m(e,t,n){let r=ws(e,t,n);return n.stack.includes(`tableCell`)&&(r=r.replace(/\|/g,`\\$&`)),r}}function zs(e){let t=e.options.bullet||`*`;if(t!==`*`&&t!==`+`&&t!==`-`)throw Error("Cannot serialize items with `"+t+"` for `options.bullet`, expected `*`, `+`, or `-`");return t}function Bs(e){let t=e.options.listItemIndent||`tab`;if(t===1||t===`1`)return`one`;if(t!==`tab`&&t!==`one`&&t!==`mixed`)throw Error("Cannot serialize items with `"+t+"` for `options.listItemIndent`, expected `tab`, `one`, or `mixed`");return t}function Vs(e,t,n,r){let i=Bs(n),a=n.bulletCurrent||zs(n);t&&t.type===`list`&&t.ordered&&(a=(typeof t.start==`number`&&t.start>-1?t.start:1)+(n.options.incrementListMarker===!1?0:t.children.indexOf(e))+a);let o=a.length+1;(i===`tab`||i===`mixed`&&(t&&t.type===`list`&&t.spread||e.spread))&&(o=Math.ceil(o/4)*4);let s=n.createTracker(r);s.move(a+` `.repeat(o-a.length)),s.shift(o);let c=n.enter(`listItem`),l=n.indentLines(n.containerFlow(e,s.current()),u);return c(),l;function u(e,t,n){return t?(n?``:` `.repeat(o))+e:(n?a:a+` `.repeat(o-a.length))+e}}var Hs={exit:{taskListCheckValueChecked:Ws,taskListCheckValueUnchecked:Ws,paragraph:Gs}},Us={unsafe:[{atBreak:!0,character:`-`,after:`[:|-]`}],handlers:{listItem:Ks}};function Ws(e){let t=this.stack[this.stack.length-2];t.checked=e.type===`taskListCheckValueChecked`}function Gs(e){let t=this.stack[this.stack.length-2];if(t&&t.type===`listItem`&&typeof t.checked==`boolean`){let e=this.stack[this.stack.length-1],n=e.children[0];if(n&&n.type===`text`){let r=t.children,i=-1,a;for(;++i<r.length;){let e=r[i];if(e.type===`paragraph`){a=e;break}}a===e&&(n.value=n.value.slice(1),n.value.length===0?e.children.shift():e.position&&n.position&&typeof n.position.start.offset==`number`&&(n.position.start.column++,n.position.start.offset++,e.position.start=Object.assign({},n.position.start)))}}this.exit(e)}function Ks(t,n,r,i){let a=t.children[0],o=typeof t.checked==`boolean`&&a&&a.type===`paragraph`,s=`[`+(t.checked?`x`:` `)+`] `,c=ts(i);o&&c.move(s);let l=Vs(t,n,r,e(e({},i),c.current()));return o&&(l=l.replace(/^(?:[*+-]|\d+\.)([\r\n]| {1,3})/,u)),l;function u(e){return e+s}}function qs(){return[Ao,ns(),vs,As,Hs]}function Js(e){return{extensions:[jo,rs(),ys,Rs(e),Us]}}function Ys(e={}){let t=this.data();n(`micromarkExtensions`,bo(e)),n(`fromMarkdownExtensions`,qs()),n(`toMarkdownExtensions`,Js(e));function n(e,n){(t[e]?t[e]:t[e]=[]).push(n)}}var Xs=t(a(),1);function Zs(e){return Xs.default.createElement(`a`,{href:e.href,target:`_blank`,rel:`noreferrer`},e.children)}function Qs({source:e}){return Xs.default.createElement(Da,{components:{a:Zs},rehypePlugins:[Ys]},e)}export{Qs as default};